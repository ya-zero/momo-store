...
resource "yandex_kubernetes_cluster" "k8s-zonal" {
  ...
  service_account_id      = yandex_iam_service_account.saaccount.id
  node_service_account_id = yandex_iam_service_account.saaccount.id
  depends_on = [
...
resource "yandex_iam_service_account" "saaccount" {
  name        = local.sa_name
...
resource "yandex_resourcemanager_folder_iam_member" "k8s-clusters-agent" {
  ...
  member    = "serviceAccount:${yandex_iam_service_account.saaccount.id}"
}
